...
class Learner(object):
    ...
    def save_model(self):
        self.actor.save('./result_actor_1.npy')
        # self.critic.save('./result_critic.npy')

    def load_model(self):
        load_actor = self.actor.load('./result_actor_1.npy')
        self.actor = load_actor
        # self.critic.load('./result_critic.npy')